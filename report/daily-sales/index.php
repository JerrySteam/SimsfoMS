...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Daily Sales Report</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <div class="row">
                <div class="col-md-3">
                  <a href="../view-customer" class="btn btn-xs btn-primary" title="View Customers"><i class="fa fa-search-plus"></i> </a>
                </div>
                <div class="col-md-6">
