...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2019 at 12:19 PM
...
INSERT INTO `tblcontainer` (`containerid`, `supplyorderid`, `description`, `hasdeficit`, `deficitdesc`, `hasoutstanding`, `outstandingdesc`, `containerref`, `shippingdate`, `seaportarrivaldate`, `clearancedate`, `datemovedtowarehouse`, `buyingprice`, `expenses`, `datecreated`, `createdby`) VALUES
(1, 6, 'Some description added', 'No', 'none', 'No', 'none', 'CO009978', '2019-10-01', '2019-10-08', '2019-10-11', '2019-10-11', 500000, 8300, '2019-10-11 12:23:56', 1),
(3, 7, 'The container has 40 different stock items', 'No', 'No deficit', 'No', 'No outstanding', 'CONT1234', '2019-10-08', '2019-10-16', '2019-10-17', '2019-10-17', 120000, 7850, '2019-10-23 03:21:02', 2),
(4, 8, 'Container from Germany', 'No', 'No deficit', 'No', 'No outstanding', 'SPL 123', '2019-10-22', '2019-10-23', '2019-10-23', '2019-10-23', 1500000, 36500, '2019-10-23 04:17:43', 2),
(5, 7, 'The container contains several products', 'No', 'No deficit', 'No', 'No outstanding', 'XYZ/GRM/345', '2019-10-23', '2019-10-24', '2019-10-25', '2019-10-25', 56000, 1500, '2019-10-25 08:25:21', 2),
(6, 9, 'This container has about 40 different items', 'No', 'No deficit', 'No', 'No outstanding', 'TMEU005', '2019-10-23', '2019-10-25', '2019-10-26', '2019-10-26', 1000000, 490000, '2019-10-26 11:18:08', 2);
...
(31, 'Add New Supplier List', 17, 'add-new-supplier-list'),
(32, 'View Supplier List', 17, 'view-supplier-list'),
...
INSERT INTO `tblstock` (`itemid`, `itemref`, `containerid`, `itemname`, `weight`, `quantity`, `buyingprice`, `costprice`, `unitsellingprice`, `dateadded`, `addedby`, `lastmodified`, `modifiedby`, `isdamaged`, `damagedesc`, `description`) VALUES
(1, 'ST00876', 1, 'Agbada', 12, 500, 0.00, 1000.00, 3000.00, '2019-10-11 12:32:43', 1, '2019-10-11 12:41:24', 1, 'Yes', 'some materials are worn out', 'Yoruba deamons agbada'),
(2, 'ST00876', 1, 'Agbada', 25, 500, 0.00, 1000.00, 3000.00, '2019-10-11 12:41:24', 1, NULL, NULL, 'Yes', 'some materials are worn out beyond repairs', 'Yoruba deamons agbada'),
(3, 'XY123', 6, 'Lady Jeans', 25, 30, 47500.00, 70775.00, 2360.00, '2019-10-30 12:01:37', 2, NULL, NULL, 'No', NULL, NULL),
(4, 'XY124', 5, 'Cotton Cap', 12, 28, 550000.00, 564732.12, 22000.00, '2019-10-30 12:06:42', 2, NULL, NULL, 'No', NULL, NULL),
(5, 'XY125', 5, 'Wool cap', 18, 35, 235800.00, 242116.06, 8500.00, '2019-10-30 12:06:42', 2, NULL, NULL, 'No', NULL, NULL),
(6, 'XY126', 5, 'Face cap', 26, 19, 126500.00, 129888.39, 7000.00, '2019-10-30 12:06:42', 2, NULL, NULL, 'No', NULL, NULL),
(7, 'YM990', 1, 'Lady Jeans', 25, 100, 100000.00, 101660.00, 1200.00, '2019-10-30 10:37:24', 2, NULL, NULL, 'No', NULL, NULL);
...
(1, 'ReSale GmbH', '07033445566', 'resale@gmail.com', 'NO 1 off Yoruba street, Germany', 80, 2, '2019-10-31 01:14:08'),
...
--
-- Table structure for table `tblsupplieritemlist`
--

CREATE TABLE `tblsupplieritemlist` (
  `itemid` int(11) NOT NULL,
  `itemref` varchar(30) NOT NULL,
...
--
-- Dumping data for table `tblsupplieritemlist`
--

INSERT INTO `tblsupplieritemlist` (`itemid`, `itemref`, `itemname`, `itemweight`, `supplierid`) VALUES
...
(9, 'SOR_15720827096661', 2, '2019-10-26', 2, 500000.00, '2019-10-26 10:38:51');
...
(25, 'exp6', 3200.00, 8, '2019-10-29 11:03:46', 2),
...
INSERT INTO `tblsupplyorderpayment` (`paymentid`, `paymentref`, `orderid`, `amountpaid`, `outstanding`, `duedate`, `datepaid`, `paymentmode`, `paymenttype`, `capturedby`) VALUES
(1, 'SPR_15719418494868', 6, 4500.00, 340500.00, '2019-10-26', '2019-10-24 07:31:14', 3, 3, 0),
(2, 'SPR_15719456971767', 7, 550000.00, 10000.00, '2019-10-25', '2019-10-24 08:36:59', 4, 3, 0),
(3, 'spr_15719518774506', 7, 3000.00, 7000.00, '2019-10-25', '2019-10-24 10:25:21', 2, 2, 0),
(5, 'SPR_15719553354453', 8, 4500.00, 4505278.00, '2019-10-26', '2019-10-24 11:17:48', 1, 2, 0),
(8, 'SPR_15719593115578', 6, 150000.00, 190500.00, '2019-10-26', '2019-10-25 12:22:27', 1, 2, 0),
(9, 'SPR_15719688179389', 8, 6000.00, 4499278.00, '2019-10-25', '2019-10-25 03:00:43', 1, 2, 0),
(10, 'SPR_15720838635620', 9, 200000.00, 300000.00, '2019-10-31', '2019-10-26 10:58:39', 3, 3, 2),
(11, 'SPR_15720839495319', 9, 180200.00, 119800.00, '2019-10-31', '2019-10-26 10:59:33', 3, 3, 2),
(12, 'SPR_15720844402669', 9, 30000.00, 89800.00, '2019-10-26', '2019-10-26 11:08:31', 3, 2, 2);
...
--
-- Indexes for table `tblsupplieritemlist`
--
ALTER TABLE `tblsupplieritemlist`
  ADD PRIMARY KEY (`itemid`);
...
--
ALTER TABLE `tblprivilege`
  MODIFY `privilegeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
-- AUTO_INCREMENT for table `tblsupplieritemlist`
--
ALTER TABLE `tblsupplieritemlist`
  MODIFY `itemid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
--
