...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add New Customer</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <div class="row">
                <div class="col-md-3">
                  <a href="../view-customer" class="btn btn-xs btn-primary" title="View Customers"><i class="fa fa-search-plus"></i> View Customers</a>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="tile-footer">
                    <button class="btn btn-primary" type="button" id="btnAddNewCustomer"><i class="fa fa-fw fa-lg fa-check-circle"></i>Proceed</button>&nbsp;&nbsp;&nbsp;
                  </div>
                </div>
