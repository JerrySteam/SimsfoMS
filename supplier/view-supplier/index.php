  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title"><a href="../add-new-supplier" class="btn btn-xs btn-primary" title="Add New Supply Order"><i class="fa fa-plus"></i> Add New Supplier</a> Suppliers Record</h3>
            <div class="tile-body">
              <?php echo ViewSuppliers();?>
            </div>
          </div>
        </div>
      </div>
