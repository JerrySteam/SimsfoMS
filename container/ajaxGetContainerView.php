                            ...
                            <div class="tile-body">
                              <form id="frmAddContainer" method="post" action="javascript:void(0)">
                                ...
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" name="buyingprice" placeholder="Enter selling price" value="'.$container['buyingprice'].'">
                                </div>
                                <div class="form-group">
                                  <label class="control-label">Expenses</label>
                                  <input class="form-control" type="text" name="expenses" placeholder="Enter cost price" value="'.$container['expenses'].'">
                                </div>
                                <div class="form-group">
