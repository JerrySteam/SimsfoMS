...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> View Roles</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">
              <a href="../add-new-role" class="btn btn-xs btn-primary col-md-2" title="Add New Role"><i class="fa fa-plus"></i> Add New Role</a> &nbsp;&nbsp;
               <span class="col-md-4 offset-3">Role Records</span>
            </h3>
            <div class="tile-body">
              <?php echo ViewRoles(); ?>
            </div>
    ...
    <?php echo getModal('editRoleModal', 'Edit Role Record'); ?>
    <!-- End main content-->
