...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add New Employee</h1>
          <p>Start a beautiful journey here</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Add New Employee</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <div class="row">
                <div class="col-md-3">
                  <a href="../view-employee" class="btn btn-xs btn-primary" title="View Employees"><i class="fa fa-search-plus"></i> View Employees</a>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="tile-body">
                    <form id="frmAddEmployee" method="post" action="javascript:void(0)">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="staffid" placeholder="Enter Staff ID">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="employmentdate" placeholder="Enter employment date">
                      </div>
                    </form>
                  </div>
                  <div class="tile-footer">
                    <button class="btn btn-primary" type="button" id="btnAddNewEmployee"><i class="fa fa-fw fa-lg fa-check-circle"></i>Proceed</button>&nbsp;&nbsp;&nbsp;
                  </div>
                </div>
